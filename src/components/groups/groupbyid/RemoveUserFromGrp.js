...
const RemoveUserFromGrp = ({ getgrpdata , userid}) => {
    ...
    return (
        <>
            ...
            <div className="modal fade" id="RemoveUserFromGrp" tabIndex="-1" aria-labelledby="RemoveUserFromGrpLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content logout-modal py-4">

                        <div className="modal-body heading text-center">
                            Want To Remove From This Group ?
                        </div>
                        <div className="modal-footer bg-transparent justify-content-center border-0 pt-4">
                            ...
                            <button type="button" onClick={() => sendinv(userid, 'remove')} className="btn primary-btn px-5"><p>Yes</p></button>
                        </div>
                    </div>
                </div>
            </div >
...
export default RemoveUserFromGrp
