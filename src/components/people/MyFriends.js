                                    ...
                                    <div className="col-xl-4 col-md-6 mt-3" key={i}>
                                        <div className="card people-card">
                                            <div className="card-body">
                                                ...
                                                <Link className='link-hov' href={'/people/slug/activity'}><p className="heading text-black mb-2 mt-4 text-capitalize">{userdata.user_id === item.user?.id ? item.friend.name : item?.user?.name}</p></Link>
