    ...
    const fetchPosts = async (page) => {
        try {
            const response = await fetch(
                `${APP_URL}/api/post/get-all-my-posts?per_page=20&page=${page}`,
                {
                    headers: {
                ...
                {AllPosts?.map((item, i) => {
                    ...
                    return <>
                        ...
                        <div className='post-card mt-4 ' key={i}>
                            <div className='post-card-body ms-md-3 mb-3 back-border rounded-3 col-xxl-7 col-lg-9 col-md-12' >
