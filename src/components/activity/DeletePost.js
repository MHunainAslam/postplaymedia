...
const DeletePost = ({ grpid, setisdlt, isdlt }) => {
    ...
    const dlrpost = (e) => {
        axios.delete(`${APP_URL}/api/post/${e}`, {
            ...
            .then(response => {
                ...
                document.querySelector('.close-post-dlt-modal').click()
                setisdlt(!isdlt)
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content logout-modal py-4">
                        ...
                        <div className="modal-footer bg-transparent justify-content-center border-0 pt-4">
                            <button type="button" className="btn secondary-btn close-post-dlt-modal px-5 text-white" data-bs-dismiss="modal">No</button>
