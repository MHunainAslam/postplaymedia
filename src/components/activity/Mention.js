            ...
            <ul className='post-border'>
                <div className='post-card mt-4'>
                    ...
                    <div className='post-card-body ms-md-3 mb-3'>
                        ...
                        <div className="">
                            <span className='clr-primary para'>@admin</span> <span className='text-black para'>Hello!</span>
                        </div>
                                    ...
                                    <div className="d-flex mt-3">
                                        ...
                                        <div className='w-100'>
                                            ...
                                            <div className="d-flex mt-1 align-items-center">
                                                <p className="para mb-0 ms-3 pointer text-black" >Rply</p>
                                    ...
                                    <div className="d-flex mt-3">
                                        ...
                                        <div className='w-100'>
                                            ...
                                            <div className="d-flex mt-3 align-items-center">
                                                ...
                                                <p className="para mb-0 ms-3 pointer clr-primary" onClick={(e) => { setCommentArea(false) }}>Cancel</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className='post-card mt-4'>
                    ...
                    <div className='post-card-body ms-md-3 mb-3'>
                        ...
                        <p className='clr-light mt-md-0 mt-2 para'>2 minutes ago</p>
                        <div className="">
                            <span className='clr-primary para'>@admin</span> <span className='text-black para'>Hi!</span>
                        </div>
                        <div className="post-card-actions">
                            <span><i className="bi bi-hand-thumbs-up "></i> Like</span>
